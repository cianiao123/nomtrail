...
- "recommendDestinations": 目的地/玩法建议。包括推荐旅游城市/国家/目的地、城市内景点/餐厅/玩法推荐、景区游玩攻略、某个目的地适合玩几天等咨询
...
7. 如果用户已明确指定城市或地区，并问"有什么好玩的地方/景点/餐厅/玩法推荐"（如"昆明有什么好玩的地方推荐"），也判断为"recommendDestinations"，但这是城市内的地点推荐，不是推荐其他目的地城市
...
2. 用户已明确指定城市或地区时，推荐该城市内的景点、街区、餐厅或玩法，不要推荐其他城市。
...
2. city 是推荐对象名称，尽量用中文；如果用户问的是城市内的景点/好玩的地方，city 应该是该城市内的景点、街区、餐厅或玩法名称
